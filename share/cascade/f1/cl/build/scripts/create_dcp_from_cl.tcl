...
##################################################
#if { [file exists $CL_DIR/build/checkpoints/last_suggestions.rqs] } {
#   puts "AWS FPGA: ([clock format [clock seconds] -format %T]) Reading in qor suggestions";
#   read_qor_suggestions $CL_DIR/build/checkpoints/last_suggestions.rqs
#}
